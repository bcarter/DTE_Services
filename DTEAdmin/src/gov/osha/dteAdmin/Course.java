...
//	private CourseLanguage courseLanguage;
    ...
    public Course(BigDecimal id, BigDecimal industryId, BigDecimal stateId, BigDecimal edCenterId,
                  BigDecimal titleId, BigDecimal langId,
//            StateCode stateCode,
...
//        setCourseLanguage(courseLanguage);
    ...
    @Column(name = "STATE_ID", nullable = false, precision = 22, scale = 0)
    ...
    @Column(name = "ED_CENTER_ID", nullable = false, precision = 22, scale = 0)
    public BigDecimal getEdCenterId() {
        return edCenterId;
    }

    public void setEdCenterId(BigDecimal edCenterId) {
        this.edCenterId = edCenterId;
    }

    @Column(name = "TITLE_ID", nullable = false, precision = 22, scale = 0)
    ...
    @Column(name = "LANG_ID", nullable = false, precision = 22, scale = 0)
